...
for i = 1:length(Nodes_Coord)
    ...
    if Nodes_Coord(1, i) == lenght || Nodes_Coord(2, i) == width %|| Nodes_Coord(3, i) == 0
...
e_new.febio_spec.Mesh.NodeSet{4} = e_boundary_p_nset;
...
e_new.febio_spec.Boundary.bc{4}.Attributes.type = 'fix'; 
e_new.febio_spec.Boundary.bc{4}.Attributes.name = 'FixedEffectiveFluidPressure';
e_new.febio_spec.Boundary.bc{4}.Attributes.node_set = 'FixedSide_p'; 
e_new.febio_spec.Boundary.bc{4}.dofs.Text = 'p';
