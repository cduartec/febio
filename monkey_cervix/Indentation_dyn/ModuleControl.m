...
e_new.febio_spec.Module.Attributes.type = 'biphasic'; 
...
e_new.febio_spec.Control.analysis.Text = 'TRANSIENT'; 
e_new.febio_spec.Control.time_steps.Text = '255'; 
...
e_new.febio_spec.Control.solver.rhoi.Text = '-2'; 
e_new.febio_spec.Control.solver.symmetric_stiffness.Text = '0'; 
e_new.febio_spec.Control.time_stepper.dtmin.Text = '0.01'; 
