...
e_new.febio_spec.Mesh.SurfacePair{1}.primary.Text = 'Secondary'; 
e_new.febio_spec.Mesh.SurfacePair{1}.secondary.Text = 'Primary'; 
...
e_new.febio_spec.Contact.contact.pressure_penalty.Text = '1.0'; 
...
%% Attributes 
e_new.febio_spec.Contact.contact.Attributes.type = 'sliding-biphasic';
