...
e_new.febio_spec.Control.time_steps.Text = '9150'; 
e_new.febio_spec.Control.step_size.Text = '1.0'; 
...
e_new.febio_spec.Control.solver.rhoi.Text = '0'; 
e_new.febio_spec.Control.solver.symmetric_stiffness.Text = '0'; 
e_new.febio_spec.Control.time_stepper.dtmin.Text = '0.005'; 
e_new.febio_spec.Control.time_stepper.dtmax.Text = ''; 
e_new.febio_spec.Control.time_stepper.dtmax.Attributes.lc = '1'; 
e_new.febio_spec.Control.time_stepper.max_retries.Text = '5'; 
e_new.febio_spec.Control.time_stepper.opt_iter.Text = '25'; 
e_new.febio_spec.Control.time_stepper.aggressiveness.Text = '0'; 
