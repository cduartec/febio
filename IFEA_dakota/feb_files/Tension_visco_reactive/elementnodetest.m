...
l_seg = round(width/elemsize);
w_seg = round(lenght/elemsize);
t_seg = round(thickness/elemsize);

basic_nodes = (0 : elemsize : w_seg*elemsize);
if basic_nodes(end) ~= lenght
    basic_nodes(end)= lenght; 
end
num_basic_nodes = length(basic_nodes); 

basic_plane = (0 : elemsize : l_seg*elemsize);
...
basic_layers = (0 : elemsize : t_seg*elemsize);
