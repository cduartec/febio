...
e_new.febio_spec.Mesh.Surface{1}.Attributes.name = 'Master'; 
...
e_new.febio_spec.Mesh.Surface{2}.Attributes.name = 'Slave'; 
...
e_new.febio_spec.Contact.contact.penalty.Text = '10'; 
